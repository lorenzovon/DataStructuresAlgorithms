...
{ // Find the periodicity of Fibanacci series (i.e. Pisano period)
  ...
  for (T i = 0; i < n; i++)
  {
    ...
    { // this might be the start of a new periods as all new period start with 01 sequence
